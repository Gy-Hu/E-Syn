...
// sha3: e6e64c318537a903891afe63b57ec3eafe72daa9f080566ca4a0fb8b3cc508c7
use crate::Expr;
...
mod __parse__Expr {
    ...
    const __ACTION: &[i8] = &[
        ...
        0, 2, 0, 3, 0, 0, 0, 16, 17,
        // State 2
        20, 6, 21, 3, 0, 22, 23, 16, 17,
        // State 3
        0, 0, 21, 0, 0, 22, 23, 0, 0,
        // State 4
        0, 2, 0, 3, 0, 0, 0, 16, 17,
        // State 5
        0, 2, 0, 3, 0, 0, 0, 16, 17,
        ...
        0, 0, 0, -8, 0, 0, 0, 0, 0,
        // State 20
        0, -11, 0, -11, 0, 0, 0, -11, -11,
        // State 21
        0, -9, 0, -9, 0, 0, 0, -9, -9,
        // State 22
        0, -10, 0, -10, 0, 0, 0, -10, -10,
        // State 23
        0, 0, -3, 0, 27, -3, -3, 0, 0,
        // State 24
        0, 0, 0, 0, 28, 0, 0, 0, 0,
    ...
    {
        // Expr = "(", NotOp, "(", Expr, Op, Expr, ")", ")" => ActionFn(10);
