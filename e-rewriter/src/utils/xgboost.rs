...
pub fn xgboost(input_string:&str) -> f64 {
    ...
    let x_test = & [x1 as f32,x2 as f32,x3 as f32,size as f32,depth as f32,sum_lib as f32,sum_node as f32,ave_lib as f32];
    let num_rows = 1;
    let y_test = &[53.05];
    ...
    //let predict as usize = bst.predict(&dtest).unwrap().0;
    predict as f64
    //predict
}
